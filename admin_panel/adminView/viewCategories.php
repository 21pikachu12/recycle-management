            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form enctype='multipart/form-data' action="./controller/addCatController.php" method="POST">
                        ...
                        <div class="form-group">
                            <label for="c_name">Product Details:</label>
                            <input type="text" class="form-control" name="p_details" required>
                        </div>
                        <div class="form-group">
                            <label for="c_name">Product Price:</label>
                            <input type="text" class="form-control" name="p_price" required>
                        </div>
                        <div class="form-group">
                            <label for="file">Choose Image:</label>
                            <input type="file" class="form-control-file" name="product_image" id="file">
                        </div>
                        <div class="form-group">
