...
$sql = "SELECT delivery_assign.*, staff.name AS collector_name FROM delivery_assign
        LEFT JOIN staff ON delivery_assign.collector_id = staff.id";
...
function handleAction(uid) {
    ...
    xhr.open("POST", "updatestatusdelivery.php", true);
